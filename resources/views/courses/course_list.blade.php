                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="{{ url('course/edit/'.$value->id) }}" class="btn btn-sm bg-danger-light">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <form action="{{ route('course/delete') }}" method="POST">
                                @csrf
                                <input type="hidden" name="course_id" class="e_course_id" value="">
                                <div class="row">
                                    <div class="col-6">
    ...
    @section('script')
        ...
        <script>
            $(document).on('click','.delete',function()
            {
                ...
                $('.e_course_id').val(_this.find('.course_id').text());
            });
        </script>
    @endsection
